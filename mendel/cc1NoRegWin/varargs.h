 ...
 *
 * $Header: /sprite/src/lib/include/sun4.md/RCS/varargs.h,v 1.3 89/07/14 09:29:20 rab Exp $ SPRITE (Berkeley)
 */
...
#define va_start(AP) (___builtin_saveregs(), (AP) = (char *)&__builtin_va_alist)
