 ...
 * Revision 1.1  90/09/07  17:03:42  roy
 * Initial revision.
 * 
 * Revision 3.2  90/05/25  16:34:49  kupfer
 * read_inferior_memory must return an error code if passed a bogus
 * address.
 * 
 * Revision 3.1  90/05/15  17:24:50  kupfer
 * gdb 3.5 from CMU.
 * 
...
fetch_inferior_registers ()
{
  ...
  if (read_inferior_memory (state.o6, &registers[REGISTER_BYTE (16)],
			    16 * sizeof(int))
      != 0)
    error("Can't read register values at 0x%x.", state.o6);
}
