 ...
 * HISTORY: 
 * $Log:	m-sun3mach.h,v $
 * Revision 1.2  91/12/11  16:07:07  kupfer
 * Add GET_CPROC_LIST definition.
 * 
 * Revision 1.1  91/12/11  15:39:29  kupfer
 * Initial revision
 * 
 * Revision 1.2  91/01/15  11:15:31  jms
 * 	JMS fixes
...
#define GET_CPROC_LIST(name)	cproc_from_misc(name)
