...
/*
 * $Log:	i386-pinsn.c,v $
 * Revision 1.1  90/09/07  16:53:32  roy
 * Initial revision.
 * 
 * Revision 3.2  90/05/25  16:30:40  kupfer
     ...
     FILE *stream;
{
  ...
  if (read_memory (memaddr, buffer, MAXLEN) != 0)
    error("Can't read memory at 0x%x to disassemble.", memaddr);
