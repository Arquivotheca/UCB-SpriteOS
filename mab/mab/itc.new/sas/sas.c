/* $Header: /sprite/src/benchmarks/itc/sas/RCS/sas.c,v 1.2 93/02/11 17:17:33 kupfer Exp $ SPRITE (Berkeley) */
...
static char *rcsid = "$Header: /sprite/src/benchmarks/itc/sas/RCS/sas.c,v 1.2 93/02/11 17:17:33 kupfer Exp $ SPRITE (Berkeley)";
