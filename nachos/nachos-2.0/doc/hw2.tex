...
% Since space, as well as time, is a performance measure,
% explain what the minimum and maximum number of bytes of useful file data
% can be stored on your disk, assuming the disk is full.
% In addition to optimizing for the performance on the provided test cases, 
% write test cases that will do well with your optimizations, and ones
% that will do badly with your optimizations.
