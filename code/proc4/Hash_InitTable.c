...
#ifndef lint
static char rcsid[] = "$Header: /user6/shirriff/rsrch/name/proc4/RCS/Hash_InitTable.c,v 1.1 91/11/21 15:57:43 shirriff Exp Locker: shirriff $ SPRITE (Berkeley)";
#endif not lint
					 ...
					 * of bytes. */
{
    ...
    tablePtr->bucketPtr = (List_Links *) malloc((unsigned) (sizeof(List_Links)
	    * tablePtr->size));
    mallocTable = sizeof(List_Links)*tablePtr->size;
